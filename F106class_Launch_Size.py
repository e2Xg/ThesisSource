...
if __name__ == "__main__":
    ...
    #Design
    design_input = load('F106class_design_input.pydata')
    
    #Geometry
    geometry_input = load('F106class_geometry_input.pydata')
    
    #Engine
    engine_input = load('F106class_engine_input.pydata')
    ...
    postprocess("F106class_sized",design_input,sized_geometry_input,engine_input,mission_input,point_performance_input,vsppath)
