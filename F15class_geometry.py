...
add_fuselage(geometry_input,capture_area_location =  6.23832,total_capture_area = 1.68,nozzle_area_location = 15.46509,total_nozzle_area = 2.155,tag="Fuselage")
...
add_general_xsec(x_location =  5.58161, z_location =  0.66315, height = 1.64465, width = 2.24705, max_width_loc = -0.31818, top_tan_angle = 26.18182,
                 bot_tan_angle = 90.0, top_str = 0.82889, bot_str = 0.56448, up_str = 0.83, low_str = 0.83, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  6.23832, z_location =  0.43185, height = 1.20433, width = 3.2, max_width_loc = 0.03636, top_tan_angle = 50.31818,
...
add_general_xsec(x_location =  7.0, z_location =  0.49488, height = 1.32415, width = 3.2, max_width_loc = 0.03636, top_tan_angle = 50.31818,
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  7.4, z_location =  0.49488, height = 1.32415, width = 3.2, max_width_loc = 0.03636, top_tan_angle = 50.31818,
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  7.72401, z_location =  0.49488, height = 1.32415, width = 3.2, max_width_loc = 0.03636, top_tan_angle = 50.31818,
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  9.20970, z_location =  0.48059, height = 1.42601, width = 3.2, max_width_loc = 0.03636, top_tan_angle = 61.77273, 
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  15.46509, z_location = 0.41352, height = 1.3, width = 3.2, max_width_loc = 0.1, top_tan_angle = 34.36364,
...
add_airfoil(x_location = 6.873, y_location = 1.600, z_location = 0.4, x_c_coords = naca64A205_x, z_c_coords = naca64A205_z, xc_c_coords = naca64A205_xc, 
...
add_airfoil(x_location = 10.302588, y_location = 1.600 + 4.89796, z_location = 0.4, x_c_coords = naca64A204_x, z_c_coords = naca64A204_z, xc_c_coords = naca64A204_xc,
...
add_airfoil(x_location = 13.0, y_location = 1.600, z_location = 0.4, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
add_airfoil(x_location = 14.5, y_location = 1.600 + 2.5, z_location = 0.4, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
biconvex5005_x, biconvex5005_z, biconvex5005_xc, biconvex5005_c, biconvex5005_xt, biconvex5005_t = biconvex5005()
add_airfoil(x_location = 13.0, y_location = 1.1, z_location = 0.8, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
add_airfoil(x_location = 14.5, y_location = 1.1 + 2.59013, z_location = 0.8, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
