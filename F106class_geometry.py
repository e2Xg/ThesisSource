...
add_fuselage(geometry_input,capture_area_location =  6.23832,total_capture_area = 0.93,nozzle_area_location = 15.46509,total_nozzle_area = 1.16,tag="Fuselage")
...
add_general_xsec(x_location =  5.58161, z_location =  0.66315, height = 1.64465, width = 2.24705, max_width_loc = -0.31818, top_tan_angle = 26.18182,
                 bot_tan_angle = 90.0, top_str = 0.82889, bot_str = 0.56448, up_str = 0.83, low_str = 0.83, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  6.23832, z_location =  0.43185, height = 1.0, width = 2.7, max_width_loc = 0.03636, top_tan_angle = 50.31818,
...
add_general_xsec(x_location =  7.0, z_location =  0.49488, height = 1.0, width = 2.7, max_width_loc = 0.03636, top_tan_angle = 50.31818,
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  7.4, z_location =  0.49488, height = 1.0, width = 2.7, max_width_loc = 0.03636, top_tan_angle = 50.31818,
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  7.72401, z_location =  0.49488, height = 1.0, width = 2.7, max_width_loc = 0.03636, top_tan_angle = 50.31818,
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  9.20970, z_location =  0.48059, height = 1.0, width = 2.7, max_width_loc = 0.03636, top_tan_angle = 61.77273, 
                 bot_tan_angle = 72.81818, top_str = 0.92135, bot_str = 1.47365, up_str = 0.89836, low_str = 1.29764, geometry = geometry_input, tag="Fuselage")
add_general_xsec(x_location =  14.2, z_location = 0.41352, height = 1.0, width = 2.7, max_width_loc = 0.1, top_tan_angle = 34.36364,
                 bot_tan_angle = 53.59091, top_str = 0.83, bot_str = 0.83, up_str = 0.83, low_str = 0.83, geometry = geometry_input, tag="Fuselage")
add_point_xsec(x_location = 14.2, z_location =  0.38957, geometry = geometry_input, tag="Fuselage")
...
add_airfoil(x_location = 6.873, y_location = 1.35, z_location = 0.3, x_c_coords = naca64A205_x, z_c_coords = naca64A205_z, xc_c_coords = naca64A205_xc, 
...
add_airfoil(x_location = 10.302588, y_location = 1.35 + 4.89796, z_location = 0.3, x_c_coords = naca64A204_x, z_c_coords = naca64A204_z, xc_c_coords = naca64A204_xc,
...
add_airfoil(x_location = 11.3, y_location = 1.35, z_location = 0.3, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
add_airfoil(x_location = 12.8, y_location = 1.35 + 2.5, z_location = 0.3, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
biconvex5005_x, biconvex5005_z, biconvex5005_xc, biconvex5005_c, biconvex5005_xt, biconvex5005_t = biconvex5005()
add_airfoil(x_location = 11.3, y_location = 0.95, z_location = 0.7, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
add_airfoil(x_location = 12.8, y_location = 0.95 + 2.59013, z_location = 0.7, x_c_coords = biconvex5005_x, z_c_coords = biconvex5005_z, xc_c_coords = biconvex5005_xc,
...
#Save Data
save('F106class_geometry_input.pydata', geometry_input)